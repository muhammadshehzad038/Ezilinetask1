...
<SafeAreaView >
        <ScrollView>
          ...
          <Text style={{fontSize:30, fontWeight:'bold',paddingTop:20,color:'#7fffd4'}}>Branding Nice Studio</Text>
         ...
         <View style={{flexDirection:'row',backgroundColor:'gray',padding:20}}>
          <TouchableOpacity style={{backgroundColor:'#2f4f4f',borderRadius:8, padding:10, shadowOpacity:'orange'}} onPress={increment}>
          <Entypo name="heart" size={24} color={heartColor} />
            </TouchableOpacity>
            <Text style={{color:likeTextColor, fontSize:22, marginLeft:10}}>Likes({count})</Text>
            <TouchableOpacity style={{backgroundColor:'#2f4f4f',borderRadius:8, padding:10, marginLeft:40}}>
